...
func (x *ExchangeRequest) Reset() {
	*x = ExchangeRequest{}
	mi := &file_proto_currency_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ExchangeRequest) Descriptor() ([]byte, []int) {
	return file_proto_currency_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *ExchangeResponse) Reset() {
	*x = ExchangeResponse{}
	mi := &file_proto_currency_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ExchangeResponse) Descriptor() ([]byte, []int) {
	return file_proto_currency_service_proto_rawDescGZIP(), []int{3}
}
...
const file_proto_currency_service_proto_rawDesc = "" +
	"\n" +
	"\x1cproto/currency_service.proto\x12\bcurrency\"c\n" +
...
var file_proto_currency_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
